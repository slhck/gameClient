...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--target-os=linux --cross-prefix=arm-linux-androideabi- --arch=arm --sysroot=/Users/werner/Binaries/android-ndk-r5b//platforms/android-3/arch-arm --soname-prefix=/data/data/at.ac.univie.gameclient/lib/ --enable-shared --disable-symver --enable-small --optimization-flags=-O2 --disable-everything --enable-encoder=mpeg2video --enable-encoder=nellymoser --prefix=../build/ffmpeg/armeabi-v7a --extra-cflags='-march=armv7-a -mfloat-abi=softfp' --extra-ldflags=
...
SONAME_PREFIX=/data/data/at.ac.univie.gameclient/lib/
SRC_PATH="/Users/werner/Dropbox/Uni/2011_SS/AMT_VU/ffmpeg-android/bambuser-ffmpeg-android/ffmpeg"
SRC_PATH_BARE=/Users/werner/Dropbox/Uni/2011_SS/AMT_VU/ffmpeg-android/bambuser-ffmpeg-android/ffmpeg
BUILD_ROOT="/Users/werner/Dropbox/Uni/2011_SS/AMT_VU/ffmpeg-android/bambuser-ffmpeg-android/ffmpeg"
...
CPPFLAGS= --sysroot=/Users/werner/Binaries/android-ndk-r5b//platforms/android-3/arch-arm -D_ISOC99_SOURCE -D_POSIX_C_SOURCE=200112 -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -DPIC
